...
router.post('/anadir', authMiddleware.isAuthenticated, authMiddleware.adminAuthorized, upload.fields([{ name: "image", maxCount: 1 }, { name: "audios" }]), audiolibrosController.newAudiolibro);
